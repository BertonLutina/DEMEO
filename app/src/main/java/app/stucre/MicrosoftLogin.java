...
*/
    ...
    private void updateSuccessUI() {
       ...
       ((TextView) findViewById(R.id.welcome)).setText("Welcome, " +
        ...
        ((TextView) findViewById(R.id.welcome)).setTextColor(Color.WHITE);


        //Intent intent = new Intent(MicrosoftLogin.this,Courses.class);
    ...
    public void updateSignedOutUI() {
        ...
        //Intent SignOut = new Intent(MicrosoftLogin.this,Intro.class);
